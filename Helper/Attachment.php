...
{
    /**
     * @var \Magentiz\AgeVerification\Helper\Upload
     */
    ...
    /**
     * @var \Magentiz\AgeVerification\Model\AttachmentFactory
     */
     ...
     * @param \Magentiz\AgeVerification\Helper\Upload $uploadModel
     * @param \Magento\Store\Model\StoreManagerInterface $storeManager
     * @param \Magento\Checkout\Model\Session $checkoutSession
     * @param \Magento\Framework\Math\Random $random
     * @param \Magento\Framework\Stdlib\DateTime\DateTime $dateTime
     * @param \Magentiz\AgeVerification\Model\AttachmentFactory $attachmentFactory
    ...
    public function __construct(
        ...
        \Magentiz\AgeVerification\Helper\Upload $uploadModel,
        \Magento\Store\Model\StoreManagerInterface $storeManager,
        \Magento\Checkout\Model\Session $checkoutSession,
        \Magento\Framework\Math\Random $random,
        \Magento\Framework\Stdlib\DateTime\DateTime $dateTime,
        \Magentiz\AgeVerification\Model\AttachmentFactory $attachmentFactory,
    ...
    public function saveAttachment($request)
    {
        try {
            ...
            $result['url'] = $this->storeManager->getStore()
                ->getBaseUrl() . "pub/media/ageverification" . $result['file'];
            ...
            $url = $this->storeManager->getStore()->getBaseUrl(
                    \Magento\Framework\UrlInterface::URL_TYPE_MEDIA) . "ageverification" . $attachment->getPath();
    ...
    public function getOrderAttachments($entityId, $byOrder = true)
    {
        ...
        if ($byOrder) {
            ...
            $baseUrl = $this->storeManager->getStore()->getBaseUrl(
                    \Magento\Framework\UrlInterface::URL_TYPE_MEDIA) . 'ageverification';
        } else {
